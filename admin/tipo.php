...
<div class="dashboard-container">
  ...
  <div class="card">
    <h3 style="margin-top:0">Agregar Nuevo Tipo</h3>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="eliminar.php?tabla=tipo&id=<?= $t['id'] ?>" onclick="return confirm('¿Eliminar este tipo?');" class="btn-danger">Eliminar</a></td>
        </tr>
        <?php endforeach; ?>
        <?php if(count($tipos)==0): ?><tr><td colspan="3" style="text-align:center;padding:20px;color:#888">No hay tipos aún.</td></tr><?php endif; ?>
      </tbody>
    </table>
  </div>
</div>
